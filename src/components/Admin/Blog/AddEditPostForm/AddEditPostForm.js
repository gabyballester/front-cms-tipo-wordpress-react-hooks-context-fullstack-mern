...
function AddEditForm(props) {
  ...
  return (
    <Form className="add-edit-post-form" layout='horizontal'>
      <Row gutter={24}>
        <Col span={8}>
          <Input
      ...
      {postData && postData.description ?
        <EditorComponent postData={postData} setPostData={setPostData} />
        : null}
      {postData && !postData.description ?
        <EditorComponent postData={postData} setPostData={setPostData} />
        : null}
...
function EditorComponent(props) {
  ...
  return (
    <Editor
      value={postData.description ? postData.description : "Escribe tu texto"}
      init={{
        height: 400,
        menubar: true,
        plugins: [
