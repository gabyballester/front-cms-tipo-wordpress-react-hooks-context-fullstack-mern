        ...
        <Row className="row-cards">
          <Col md={8}>
            <CardInfo
              ...
              description="Aprende y mejora tu perfil para mantenerte informado de actualizaciones en relación a las nuevas tecnologías más demandadas en el mercado laboral."
            />
          </Col>
          <Col md={8}>
            <CardInfo
              icon={<Icon.EuroOutlined/>}
              title="Precios bajos"
          ...
          <Col md={8}>
            <CardInfo
              ...
              description="Al completar un curso recibirás una certificación que te expedirá Udemy en PDF acreditando que lo has cursado satisfactoriamente."
            />
          </Col>
        </Row>
      </Col>
